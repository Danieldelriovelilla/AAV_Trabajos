    ...
    for y = 1:2:3
        for b = 1:2:3
            ...
            plot(-numerics{y}(b,e).a/9.81,numerics{y}(b,e).z/1000,...
                 line_style{b}, 'Color', colors(y+1,:), 'LineWidth', 2,...
                 'DisplayName', eval(leg_str_bn))
        end
    end
...
y = 1;
    for e = 2:3
        for b = 1:2:3
            ...
            line_style{b}, 'Color', colors(2*e-3,:), 'LineWidth', 2,...
                 'DisplayName', eval(leg_str_ga));
            plot(numerics{y}(b,e).u/numerics{y}(b,e).u0,...
                 numerics{y}(b,e).z/1000, line_style{b},...
                 'Color', colors(2*e-2,:), 'LineWidth', 2,...
    ...
    for e = 2:3
        for b = 1:2:3
            ...
            line_style{b}, 'Color', colors(2*e-3,:), 'LineWidth', 2,...
                 'DisplayName', eval(leg_str_ga));
            plot(-numerics{y}(b,e).a/9.81,numerics{y}(b,e).z/1000,...
                 line_style{b}, 'Color', colors(2*e-2,:), 'LineWidth', 2,...
                 'DisplayName', eval(leg_str_gn))
        end
    end
